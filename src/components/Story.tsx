    ...
    <section className="py-24 px-6 bg-white text-black relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 border border-gray-300 text-gray-900 text-sm mb-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 leading-tight">
              ...
              <span className="block text-gray-900">Branding Inteligente</span>
            </h2>
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 hover:border-gray-400 transition-all duration-300 group">
        ...
        <div className="mt-16 p-8 md:p-12 bg-gradient-to-r from-gray-100 via-gray-50 to-transparent rounded-3xl border border-gray-300">
          <div className="flex items-start gap-6">
            <div className="flex-shrink-0 text-6xl leading-none text-gray-900 font-serif">"</div>
            <div>
              <blockquote className="text-2xl md:text-3xl font-medium leading-relaxed mb-4">
                ...
                <span className="text-gray-900 font-bold"> amplificar essa visão</span>.
              </blockquote>
            </div>
          </div>
        </div>
