    ...
    <section className="py-24 px-6 bg-black text-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-900 border border-gray-700 text-gray-100 text-sm mb-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 leading-tight">
              ...
              <span className="block text-white">Branding Inteligente</span>
            </h2>
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-8 border border-gray-800 hover:border-gray-600 transition-all duration-300 group">
              <div className="w-12 h-12 bg-gray-800 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="mt-16 p-8 md:p-12 bg-gradient-to-r from-gray-900 via-gray-800 to-transparent rounded-3xl border border-gray-700">
          <div className="flex items-start gap-6">
            <div className="flex-shrink-0 text-6xl leading-none text-gray-400 font-serif">"</div>
            <div>
              <blockquote className="text-2xl md:text-3xl font-medium leading-relaxed mb-4">
                ...
                <span className="text-white font-bold"> amplificar essa visão</span>.
              </blockquote>
            </div>
          </div>
        </div>
