  ...
  return (
    <section className="py-24 px-6 bg-white text-black relative overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-gray-100 rounded-full blur-[120px]"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-xl md:text-2xl text-gray-700 leading-relaxed">
          Designers e estrategistas estão sendo substituídos — não por IA, mas por <span className="text-gray-900 font-semibold">quem sabe usá-la com propósito.</span>
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          {[
            ...
            <div key={i} className="bg-gray-50 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 hover:border-gray-400 transition-all duration-300">
